...
public class Deathbanpage {
		...
		public static boolean openGUI(Player player) {
			...
			if (Main.plugin.getConfig().getBoolean("Features.Deathban.Enabled") == false) {
				Deathban.setItem(13, Bossmobitems.Enabledeathban);
			} else {
				Deathban.setItem(13, Bossmobitems.Disabledeathban);
			}
